 ...
 */
/*$Id: Main.as,v 1.1 2005-04-25 20:32:24 christianfoltin Exp $*/
/**
* Main Class
* Author : Juan Pedro de Andres
* This class is configured to be the called from MSTAC (Motion-Twin ActionScript 2 Compiler)
*/
class Main {
		...
		static public function run ():Boolean
	   {
		   ...
		   Logger.trace("initial mindmap:"+_root.initLoadFile);

			// Creation of prototipes for MovieClip
		   createPrototypes();

		   if(_root.initLoadFile!=null) // If not defined init mindmap file, use default (index.mm)
			   var browser=new Browser(_root.initLoadFile,_root);
			else
			   var browser2=new Browser("index.mm",_root);
			return true;
		}

		//
		static function createPrototypes(){
			// For doing dashed lines, not used yet.
			...
			// This prototype was created by  ( Search I don´t remember now)

 ...
 */
/* $Id: UsePlainTextAction.java,v 1.1.2.1 2006-04-05 19:19:42 dpolivaev Exp $ */
...
public class UsePlainTextAction extends AbstractAction {
   ...
   public UsePlainTextAction(ControllerAdapter controller) {
   ...
   public void actionPerformed(ActionEvent e) {
      if (controller.getMap() == null) {
         return; }
      controller.getController().setProperty("use_rich_text_in_new_long_nodes","false");
      for(ListIterator it = controller.getView().getSelecteds().listIterator();it.hasNext();) {
         NodeView selected = (NodeView)it.next();
         String nodeText = selected.getModel().toString();
         if (nodeText.startsWith("<html>")) {

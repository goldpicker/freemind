 ...
 */
/*$Id: FreeMind.java,v 1.32.14.17.2.1.2.25 2006-04-05 18:54:32 dpolivaev Exp $*/
...
public class FreeMind extends JFrame implements FreeMindMain {
    ...
    public static final String VERSION = "0.8.1.FA Alpha 10.02";
...
//	getContentPane().add( status, BorderLayout.SOUTH );
    ...
    public static void main(String[] args) {
        ...
        FreeMindSplash splash = new FreeMindSplash(frame);
        splash.setVisible(true);
        FeedBack feedBack = splash.getFeedBack();
		feedBack.setMaximumValue(10);
        frame.init(feedBack);
